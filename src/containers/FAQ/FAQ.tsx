...
export const FAQ = () => (
  <section className={styles.section}>
    ...
    <div>
      ...
      <div className={styles.answer}>
        just type the mnemonic (12 words) on another device. all your data will
        sync automatically
      </div>
      ...
      <div className={styles.answer}>
        ...
        e2e encrypted using your private key (derived from mnemonic). only your
        other device with the same mnemonic set can decrypt the data
      </div>
